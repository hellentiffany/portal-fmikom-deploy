...
<section style="margin-bottom: 10px; text-align: center;">
    ...
    <div style="color: #00b050; font-family: inherit; font-weight: 700; line-height: 1.04; text-align: center;">
...
HTML,
            ...
            [
                'jenis_surat_slug' => 'surat-tugas-laboratorium',
                'name' => 'Template Surat Tugas Laboratorium',
                'slug' => 'template-surat-tugas-laboratorium',
                'source_reference' => 'template-surat-tugas-laboratorium.docx',
                'subject' => 'Surat Tugas Laboratorium',
                'template_body' => <<<'HTML'
<section class="surat surat-tugas-laboratorium">
    <h1 style="text-align:center;">SURAT TUGAS LABORATORIUM</h1>
    <p style="text-align:center;">Nomor: {{nomor_surat}}</p>

    <p>Yang bertanda tangan di bawah ini menetapkan:</p>
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 8px;">
        <tbody>
            <tr>
                <td style="width: 150px; padding: 1px 0;">Nama Petugas</td>
                <td style="width: 14px; padding: 1px 0;">:</td>
                <td style="padding: 1px 0;">{{nama_petugas}}</td>
            </tr>
            <tr>
                <td style="padding: 1px 0;">Jabatan</td>
                <td style="padding: 1px 0;">:</td>
                <td style="padding: 1px 0;">{{jabatan_petugas}}</td>
            </tr>
            <tr>
                <td style="padding: 1px 0;">Tempat Tugas</td>
                <td style="padding: 1px 0;">:</td>
                <td style="padding: 1px 0;">{{tempat_tugas}}</td>
            </tr>
            <tr>
                <td style="padding: 1px 0;">Tanggal</td>
                <td style="padding: 1px 0;">:</td>
                <td style="padding: 1px 0;">{{tanggal_mulai_panjang}} s.d. {{tanggal_selesai_panjang}}</td>
            </tr>
        </tbody>
    </table>

    <p style="text-align: justify;">
        Untuk melaksanakan tugas: {{uraian_tugas}}.
    </p>
    ...
    <p style="margin-top: 10px;">{{kota_surat}}, {{tanggal_surat_panjang}}</p>
    <p><strong>{{penanda_tangan_jabatan}}</strong></p>
    <br><br>
    <p><strong>{{penanda_tangan_nama}}</strong></p>
</section>
HTML,
                'placeholders' => [
                    ['placeholder_key' => 'nomor_surat', 'label' => 'Nomor Surat', 'source_type' => 'surat', 'source_key' => 'nomor_surat', 'is_required' => true, 'description' => 'Nomor surat final.'],
                    ['placeholder_key' => 'nama_petugas', 'label' => 'Nama Petugas', 'source_type' => 'surat_data', 'source_key' => 'nama_petugas', 'is_required' => true, 'description' => 'Nama petugas yang ditugaskan.'],
                    ['placeholder_key' => 'jabatan_petugas', 'label' => 'Jabatan Petugas', 'source_type' => 'surat_data', 'source_key' => 'jabatan_petugas', 'is_required' => true, 'description' => 'Jabatan atau posisi petugas.'],
                    ['placeholder_key' => 'tempat_tugas', 'label' => 'Tempat Tugas', 'source_type' => 'surat_data', 'source_key' => 'tempat_tugas', 'is_required' => false, 'description' => 'Lokasi penugasan.'],
                    ['placeholder_key' => 'tanggal_mulai_panjang', 'label' => 'Tanggal Mulai Panjang', 'source_type' => 'computed', 'source_key' => 'tanggal_mulai_panjang', 'is_required' => true, 'description' => 'Tanggal mulai dalam format panjang.'],
                    ['placeholder_key' => 'tanggal_selesai_panjang', 'label' => 'Tanggal Selesai Panjang', 'source_type' => 'computed', 'source_key' => 'tanggal_selesai_panjang', 'is_required' => true, 'description' => 'Tanggal selesai dalam format panjang.'],
                    ['placeholder_key' => 'uraian_tugas', 'label' => 'Uraian Tugas', 'source_type' => 'surat_data', 'source_key' => 'uraian_tugas', 'is_required' => true, 'description' => 'Detail tugas laboratorium.'],
                    ['placeholder_key' => 'kota_surat', 'label' => 'Kota Surat', 'source_type' => 'system', 'source_key' => 'kota_surat', 'is_required' => true, 'default_value' => 'Cilacap', 'description' => 'Kota penerbitan surat.'],
                    ['placeholder_key' => 'tanggal_surat_panjang', 'label' => 'Tanggal Surat Panjang', 'source_type' => 'computed', 'source_key' => 'tanggal_surat_panjang', 'is_required' => true, 'description' => 'Tanggal final surat.'],
                    ['placeholder_key' => 'penanda_tangan_jabatan', 'label' => 'Jabatan Penanda Tangan', 'source_type' => 'system', 'source_key' => 'penanda_tangan_jabatan', 'is_required' => true, 'default_value' => 'Kepala Lab', 'description' => 'Jabatan penanda tangan.'],
                    ['placeholder_key' => 'penanda_tangan_nama', 'label' => 'Nama Penanda Tangan', 'source_type' => 'system', 'source_key' => 'penanda_tangan_nama', 'is_required' => true, 'description' => 'Nama pejabat penanda tangan.'],
                ],
            ],
            [
                'jenis_surat_slug' => 'surat-undangan-fakultas',
                'name' => 'Template Surat Undangan Fakultas',
                'slug' => 'template-surat-undangan-fakultas',
                'source_reference' => 'template-surat-undangan-fakultas.docx',
                'subject' => 'Surat Undangan Fakultas',
                'template_body' => <<<'HTML'
<section class="surat surat-undangan-fakultas">
    <h1 style="text-align:center;">SURAT UNDANGAN FAKULTAS</h1>
    <p style="text-align:center;">Nomor: {{nomor_surat}}</p>
    ...
    <p style="text-align: justify;">
        Dengan hormat, bersama ini kami mengundang Bapak/Ibu/Saudara(i) untuk menghadiri
        kegiatan berikut:
    </p>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 8px;">
        <tbody>
            <tr>
                <td style="width: 150px; padding: 1px 0;">Agenda</td>
                <td style="width: 14px; padding: 1px 0;">:</td>
                <td style="padding: 1px 0;">{{agenda}}</td>
            </tr>
            <tr>
                <td style="padding: 1px 0;">Waktu</td>
                <td style="padding: 1px 0;">:</td>
                <td style="padding: 1px 0;">{{waktu_acara}}</td>
            </tr>
            <tr>
                <td style="padding: 1px 0;">Tempat</td>
                <td style="padding: 1px 0;">:</td>
                <td style="padding: 1px 0;">{{tempat_acara}}</td>
            </tr>
        </tbody>
    </table>

    <p style="text-align: justify;">
        Demikian undangan ini kami sampaikan. Kehadiran Bapak/Ibu/Saudara(i) sangat kami harapkan.
    </p>
...
HTML,
                'placeholders' => [
                    ['placeholder_key' => 'nomor_surat', 'label' => 'Nomor Surat', 'source_type' => 'surat', 'source_key' => 'nomor_surat', 'is_required' => true, 'description' => 'Nomor surat final.'],
                    ['placeholder_key' => 'kepada', 'label' => 'Kepada', 'source_type' => 'surat_data', 'source_key' => 'kepada', 'is_required' => true, 'description' => 'Tujuan undangan.'],
                    ['placeholder_key' => 'perihal', 'label' => 'Perihal', 'source_type' => 'surat_data', 'source_key' => 'perihal', 'is_required' => true, 'description' => 'Perihal undangan.'],
                    ['placeholder_key' => 'agenda', 'label' => 'Agenda', 'source_type' => 'surat_data', 'source_key' => 'agenda', 'is_required' => true, 'description' => 'Agenda kegiatan.'],
                    ['placeholder_key' => 'waktu_acara', 'label' => 'Waktu Acara', 'source_type' => 'surat_data', 'source_key' => 'waktu_acara', 'is_required' => true, 'description' => 'Waktu pelaksanaan kegiatan.'],
                    ['placeholder_key' => 'tempat_acara', 'label' => 'Tempat Acara', 'source_type' => 'surat_data', 'source_key' => 'tempat_acara', 'is_required' => true, 'description' => 'Tempat kegiatan berlangsung.'],
                    ['placeholder_key' => 'kota_surat', 'label' => 'Kota Surat', 'source_type' => 'system', 'source_key' => 'kota_surat', 'is_required' => true, 'default_value' => 'Cilacap', 'description' => 'Kota penerbitan surat.'],
                    ['placeholder_key' => 'tanggal_surat_panjang', 'label' => 'Tanggal Surat Panjang', 'source_type' => 'computed', 'source_key' => 'tanggal_surat_panjang', 'is_required' => true, 'description' => 'Tanggal final surat.'],
                    ['placeholder_key' => 'penanda_tangan_jabatan', 'label' => 'Jabatan Penanda Tangan', 'source_type' => 'system', 'source_key' => 'penanda_tangan_jabatan', 'is_required' => true, 'default_value' => 'Sekretaris Fakultas', 'description' => 'Jabatan penanda tangan.'],
                    ['placeholder_key' => 'penanda_tangan_nama', 'label' => 'Nama Penanda Tangan', 'source_type' => 'system', 'source_key' => 'penanda_tangan_nama', 'is_required' => true, 'description' => 'Nama pejabat penanda tangan.'],
                ],
            ],
        ];
